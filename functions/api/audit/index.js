...
import { ensureAuditSchema } from "../../_lib/schema.js";
...
export async function onRequest(context) {
  ...
  try {
    ...
    return errorJson(500, "failed to initialize audit schema", { detail: String(e && e.message ? e.message : e) });
  }
  ...
  try {
    ...
    return errorJson(500, "failed to load audit logs", { detail: String(e && e.message ? e.message : e) });
  }
}
